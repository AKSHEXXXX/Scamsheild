...
def load_all_models():
    ...
    if v is not None and c is not None:
        ...
        logger.error("[STARTUP] Agent 1 — Text TF-IDF + LogReg FAILED")
    ...
    if "agent3_classifier" in old:
        ...
        logger.error("[STARTUP] Agent 3 — URL XGBoost FAILED")
    ...
    if "agent5_classifier" in old:
        ...
        logger.info("[STARTUP] Agent 5 — QR XGBoost FAILED")
    ...
    if "agent6_upi_engine" in old:
        ...
        logger.info("[STARTUP] Agent 6 — UPI Heuristic FAILED")
    ...
    if "agent7_classifier" in old:
        ...
        logger.info("[STARTUP] Agent 7 — UPI XGBoost FAILED")
    ...
    if "agent8_whitelist" in old:
        ...
        _reports["agent8"] = {"precision": rep.get("precision", rep.get("Precision", "see report"))}
        logger.info("[STARTUP] Agent 8 — Brand Guard v1 loaded ✓")
    else:
        logger.info("[STARTUP] Agent 8 — Brand Guard v1 FAILED")
    ...
    if "agent11_classifier" in old:
        ...
        logger.info("[STARTUP] Agent 11 — Malware RF FAILED")
    ...
    if "agent14_regex_rules" in old:
        ...
        logger.info("[STARTUP] Agent 14 — Regex Engine FAILED")
        _reports["agent14"] = {"type": "N/A"}
